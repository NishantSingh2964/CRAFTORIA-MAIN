...
const MostReviewedProducts = () => {
  ...
  if (topReviewedProducts.length === 0) return null;
  ...
  return (
    <section className="site-container py-6 sm:py-8 bg-white">
      ...
      <div className="overflow-hidden">
        <div className="animate-marquee hover:[animation-play-state:paused] flex gap-5 sm:gap-6 pb-4" style={{ '--duration': '80s' }}>
          {[...topReviewedProducts, ...topReviewedProducts].map((product, idx) => (
