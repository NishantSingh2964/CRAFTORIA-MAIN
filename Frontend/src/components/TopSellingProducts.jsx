  ...
  if (loading && products.length === 0) {
    return (
      <div className="site-container py-12 text-center">
        <p className="text-gray-500 animate-pulse">Loading best sellers...</p>
      </div>
    );
  }
  ...
  return (
    <section className="site-container py-6 sm:py-8 bg-white">
      ...
      <div className="overflow-hidden">
        <div className="animate-marquee hover:[animation-play-state:paused] flex gap-5 sm:gap-6 pb-4" style={{ '--duration': '60s' }}>
