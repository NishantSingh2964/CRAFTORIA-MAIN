...
const PersonalizationModal = ({
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center px-4 py-5 sm:p-4">
      ...
      <div className="relative max-h-[85vh] w-full max-w-[420px] overflow-y-auto rounded-xl bg-white shadow-2xl animate-in zoom-in-95 duration-300 sm:max-w-xl lg:max-w-2xl">
              ...
              <div className="space-y-3">
                ...
                <div className="group relative">
                  <textarea
                    ...
                    placeholder="Enter the name, quote, or personalized message..."
                    rows={4}
                    maxLength={300}
                    className="w-full resize-none rounded-lg border border-gray-200 bg-gray-50/30 px-4 py-3 text-sm font-medium outline-none transition-all focus:border-[#760000]/40 focus:ring-8 focus:ring-[#760000]/5 min-h-[110px] sm:min-h-[120px] lg:min-h-[100px] sm:px-5"
                  />

                  {text.trim() && (
                    <CheckCircle2 className="absolute right-4 top-4 h-5 w-5 animate-in zoom-in text-green-500" />
                  )}
                </div>
            ...
            {isPhotoRequired && (
              <div className="space-y-3">
                ...
                <div
                  ...
                  className={`group relative flex cursor-pointer flex-col items-center justify-center gap-3 overflow-hidden rounded-xl border-2 border-dashed p-5 transition-all duration-300 sm:p-6 lg:p-5 ${photoPreview
