        ...
        <div className="relative z-10 text-center px-12">
          ...
          <div className="space-y-6 max-w-lg mx-auto">
            <h1 className="text-4xl xl:text-5xl font-serif font-bold text-white leading-tight">
              Create Memories, <br />
              <span className="text-red-200">Join Craftoria.</span>
            </h1>
            ...
            <div className="p-5 sm:p-7">
                  ...
                  <div>
                    ...
                    <div className="relative group">
                      ...
                      <input
                        ...
                        className="block w-full pl-11 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#760000]/20 focus:border-[#760000] focus:bg-white transition-all text-sm"
              ...
              <div className="mt-5">
                <div className="relative flex items-center gap-4 text-xs font-bold text-gray-400 uppercase tracking-widest">
                  ...
                  <span className="whitespace-nowrap scale-90">Or Social Register</span>
                  <div className="h-px w-full bg-gray-100"></div>
                </div>
